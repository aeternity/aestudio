import { Directive, ElementRef, Renderer2, HostListener, AfterViewInit, OnInit, AfterContentInit, AfterViewChecked } from '@angular/core';
...
export class MdwUrlDirective {
  ...
  constructor(private el: ElementRef, private compiler: CompilerService, private renderer: Renderer2) {
    this.addUrl()
  }
